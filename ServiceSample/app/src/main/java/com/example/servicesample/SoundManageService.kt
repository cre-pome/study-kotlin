...
class SoundManageService : Service() {
    ...
    override fun onCreate(){
        ...
        // 通知チャネルを生成
        val chanel = NotificationChannel(id, name, importance)
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        // 音声ファイルのURI文字列を作成
        val mediaFileUriStt = "android.resource://${packageName}/${R.raw.mountain_stream}"

        // 音声ファイルのURI文字列を元にURIオブジェクトを生成
        val mediaFileUri = Uri.parse(mediaFileUriStt)
